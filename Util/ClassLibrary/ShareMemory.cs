...
namespace Util
{
    ...
    public class ShareMenmory<T>
    {
        ...
        public string GetUrl(int index)
        {
            ...
            return Read(200, offset).toString().Trim();
        }
        ...
        {
            int offset = 1 + index * (entityLength + 1) + entityLength - 2;
            Write(state.ToString().Tobyte(),offset);
        }
        ...
        public void SetEntity(int index,T t)
        {
            ...
            Write(t.EntityToJson().Tobyte(), offset);
        }

        public T GetEntity(int index)
        {
            string str = Read(entityLength, index * entityLength).toString();
